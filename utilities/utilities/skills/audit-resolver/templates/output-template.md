...
|----|----------|--------|---------------------------|
| F00A | SUGGESTION | User chose defer | Re-invoke `/utilities:audit-resolve --severity=suggestion` when ready |
...
- "Re-run `/utilities:plan-completion-audit` to confirm closure."
